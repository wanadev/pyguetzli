...
class Test_process_jpeg_bytes(object):
    ...
    def test_quality_param(self):
        optimized_jpeg_bytes_q100 = guetzli.process_jpeg_bytes(self.jpeg_bytes, 100)
        optimized_jpeg_bytes_q50 = guetzli.process_jpeg_bytes(self.jpeg_bytes, 50)
...
class Test_process_rgb_bytes(object):
    ...
    def test_wrong_width_height(self):
        with pytest.raises(ValueError):
            optimized_jpeg_bytes = guetzli.process_rgb_bytes(self.rgb_bytes, 4, 4)
